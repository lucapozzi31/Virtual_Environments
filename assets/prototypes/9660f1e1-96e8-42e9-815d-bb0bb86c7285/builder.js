...
function configure3D() {
    ...
    conveyor('main', length, false, true, false, true, -length * 0.5);
    conveyor('outConv1', out1Length, true, false, true, false, out1Length * 0.25).translate(0.5 * (length), out1Length * 0.5, 0).rotate(0, 0, 90);
    conveyor('outConv2', out2Length, true, false, true, false, out2Length * 0.25).translate(0.5 * (length), -out2Length * 0.5, 0).rotate(0, 0, -90);
    conveyor('outConv3', out3Length, true, false, true, false, out3Length * 0.25).translate(0.5 * (length + out3Length), 0, 0);
